...
fwrite(
  votes_zcta_agg1, 
  file = "Produced Datasets/election-results-zcta-2016-areal-method.csv", 
...
fwrite(
  votes_zcta_agg2, 
  file = "Produced Datasets/election-results-zcta-2016-imperviousness-method.csv", 
  sep = ",",          # Use a comma as the separator
  quote = TRUE,       # Quote character strings to handle special characters
  bom = TRUE,         # Add BOM for compatibility with Excel
  encoding = "UTF-8"  # Ensure UTF-8 encoding
...
fwrite(
  votes_zcta_agg3, 
  file = "Produced Datasets/election-results-zcta-2016-landcover-method.csv", 
  sep = ",",          # Use a comma as the separator
  quote = TRUE,       # Quote character strings to handle special characters
  bom = TRUE,         # Add BOM for compatibility with Excel
  encoding = "UTF-8"  # Ensure UTF-8 encoding
